public class Capitulo {
    ...
    "\n\n-Tá bom, tá bom já chega, assim voce joga sujo e eu tenho que sair lembra?. mas não se preucupa eu trago algo pra voce mais tarde.-"+
     "Indo até o banheiro voce olha o espelho, a barba está um mesclado do preto e grisalho mas ainda não tá na hora de aparar,mas se bem que pelo corpo talvez esteja na hora,"+"de qualquer forma preciso de um banho." +
    ...
    static String Historia1B = "Ao chegar na cafeteria voce para o carro no estacionamento, O ar do ambiente chega é aconchegante "+
    ...
    " \n\nA: -Bom dia Hank, me surpreende a sua disposição pra caminhar a essa hora, Quer se juntar a mim?-Ele pensa um pouco antes de falar, ainda ofegante depois de toda corrida. -...Quer saber, porque não? -Diz enquanto enxuga o suor"+
     ...
     " pro corpo. \n\nA: -Eu tenho um cachorro, ele... ajuda a lidar com tudo, mas oia nosso pedido já tá vindo.- Depois de comer voce recebe uma ligação do da policia local a respeito de um caso "+"de assassinato no subúrbio da cidade. "+
     "- Hank vamos, tem um novo caso descendo até o subúbio";

    static String Historia1C = "\nAo chegar na cena voce observa a casa, por fora está muito precária com partes dela caindo e o jardim da frente muito grande, como se não fosse cuidado a semanas. voce se"+ 
    ...
    static String História2 = "";

    int escolha1A = 0;
    int escolha2A = 0;
    int escolha3A = 0;
    static String Escolha1A = "Voce se abaixa um pouco próximo ao corpo, mesmo estando em sua casa ela parece estar muito bem arrumada, algo como uma saia e "+
    ...
    static String Escolha2A = "Voce olha em volta a procura algo que pareça útil... ,até que voce avista um telfone com uma capa rosa na bancada estilo americano da cozinha,"+ 
    ...
    static String Historia1D = "De repente voce escuta um barulho vindo de cima das escadas.... correndo até lá voce vê Hank caído no chão de um quarto com um corte no braço."+
    ...
    static String Historia2A =  "Acordar abruptamente sempre foi um saco... assim como um bebê no útero que é jogado no mundo frio e claro, voce pensa no cansaço do corpo em como dormir num banco de praça depois"+
    "de caminhar foi uma péssima ideia, infelizmente nada é melhor pra esvaziar a mente e é exatamente o que eu tô precisando agora. Após um boa esticada é melhor voltar a correria. Com"+
    "um bossejo bem grande voce volta ao pique da corrida, acho que não consigo pensar numa forma melhor de começar a manhã, sinto o meu corpo fervendo desde cedo e isso me ajuda a"+
    "ficar cada vez mais alerta no trabalho."+
    "Agora passando pelo final do parque voce consegue ver que a população de idosos realmente gosta de acordar cedo, Imaginando se ainda vai ser tão ativo quando chegar na idade deles,"+
    "Nossa eu penso isso mesmo tendo só 38, o Al está realmente entrando na minha cabeça ...que horror. Depois de passar por algumas pessoa e sair do parque voce sobe a rua, o centro "+
    "sempre tava chegando lojas novas e não tem porque não dar uma olhada.";
    static String Historia2B = "A medida que voce vai olhando nota que não tem tanta novidade assim, até que voce encontra uma cara amiga...\n"+
    ...
    "\n\nDiz enquanto enxuga o suor com uma toalha de carregava em direção a entrada. Sentando na mesa voce lembra de uma bebida que ele costumava falar... "+"Cappuchino"+"? Acho que sim, voce "+
    "pede pra provar enquanto se acomoda na mesa."+
    "\n\nH: -Serio que a minha caminhada é o 'incomum' toda semana voce toma café da manhã em um lugar diferente."+
    ...
    static String Escolha(int esc1, int esc2,int esc3){
        if(esc1 == 1 && esc2 == 0 && esc3 == 0){
            return Escolha1A;
        }
        else if(esc1 == 0 && esc2 == 1 && esc3 == 0){
            return Escolha2A;
        }
        else if(esc1 == 0 && esc2 == 0 && esc3 == 1){
            return Escolha3A;
        }
    return "";
    }
